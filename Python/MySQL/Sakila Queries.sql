...
select address.city_id, customer.first_name, customer.last_name, customer.email, address
from customer
...
select actor.actor_id, concat(actor.first_name, ' ', actor.last_name) as Actor_Name, title, description, release_year
from film
